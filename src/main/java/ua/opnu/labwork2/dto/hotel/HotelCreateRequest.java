...
@Schema(description = "Запит на створення нового готелю")
public record HotelCreateRequest(
        ...
        @Schema(description = "Місто, де розташований готель", example = "Київ",
                requiredMode = Schema.RequiredMode.REQUIRED, minLength = 2, maxLength = 150)
        ...
        @Schema(description = "Поштова адреса готелю", example = "вул. Хрещатик, 1",
        ...
        @Schema(description = "Рейтинг готелю (кількість зірок)", example = "5",
