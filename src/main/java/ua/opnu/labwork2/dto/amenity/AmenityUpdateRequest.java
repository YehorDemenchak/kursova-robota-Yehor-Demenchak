...
@Schema(description = "Запит на оновлення зручності")
public record AmenityUpdateRequest(

        @Schema(description = "Назва зручності", example = "Кондиціонер",
        ...
        @Schema(description = "Розгорнутий опис",
                example = "Індивідуальний клімат-контроль у номері",
